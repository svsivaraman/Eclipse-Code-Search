 ...
 *  @author ProSoft
 * 
 * This RepositoryView class demonstrates how to plug-in a new workbench view.
 ...
 * <p>
 * This view uses a label provider to define how model objects should be
 * presented in the view. Each view can present the same model objects
 * using different labels and icons, if needed. Alternatively, a single
 * label provider can be shared between views in order to ensure that
...
public class RepositoryView extends ViewPart {
     ...
     */
    public static final String ID = "sampleplugin.views.RepositoryView";

    private TableViewer viewer;
    private Image imageSave, imageDelete;
	...
	GridLayout grid2=new GridLayout(4,false);
	...
	GridData gdTitle = new GridData(SWT.LEFT, SWT.TOP, true, true, 3, 1);
	...
	final Text tagInput = new Text(group3, SWT.BORDER);
	...
	GridData gridData5 = new GridData(SWT.FILL, SWT.FILL, true, true, 4, 1);
